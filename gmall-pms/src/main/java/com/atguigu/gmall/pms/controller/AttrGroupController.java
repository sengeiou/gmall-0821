...
public class AttrGroupController {
    ...
    public ResponseVo<List<AttrGroupEntity>> queryGroupsWithAttrsByCid(@PathVariable Long catId) {
    ...
    public ResponseVo<List<AttrGroupEntity>> queryGroupsByCid(@PathVariable Long cid) {
