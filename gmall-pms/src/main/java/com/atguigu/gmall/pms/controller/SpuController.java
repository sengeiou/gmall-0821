...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpuByCidAndPage(PageParamVo pageParamVo,@PathVariable Long categoryId) {
        PageResultVo resultVo = this.spuService.querySpuByCidAndPage(pageParamVo, categoryId);
