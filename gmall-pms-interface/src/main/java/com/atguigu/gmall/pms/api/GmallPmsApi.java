...
public interface GmallPmsApi {
    ...
    public ResponseVo<List<SkuEntity>> querySkusBySpuId(@PathVariable Long spuId);
    ...
    public ResponseVo<List<CategoryEntity>> query123CategoriesByCid3(@PathVariable Long cid);
    ...
    public ResponseVo<List<CategoryEntity>> queryLvl2CatesWithSubsByPid(@PathVariable Long pid);
    ...
    public ResponseVo<String> querySaleAttrsMappingSkuIdBySpuId(@PathVariable Long spuId);

    @GetMapping("pms/skuattrvalue/spu/{spuId}")
    public ResponseVo<List<SaleAttrValueVo>> querySaleAttrsBySpuId(@PathVariable Long spuId);

    @GetMapping("pms/skuattrvalue/sku/{skuId}")
    public ResponseVo<List<SkuAttrValueEntity>> querySaleAttrValuesBySkuId(@PathVariable Long skuId);
